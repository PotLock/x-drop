...
import { setupWalletSelector, NetworkId, Network, WalletSelector } from "@near-wallet-selector/core";
...
export class Wallet {
   ...
   */
  constructor({ networkId = "testnet" as NetworkId, createAccessKeyFor }: {
    networkId?: NetworkId;
  ...
  startUp = async (accountChangeHook: (accountId: string | undefined) => void) => {
    ...
    walletSelector.store.observable
      .pipe(
        map((state: WalletState) => state.accounts),
   ...
   */
  signIn = async () => {
    if (!this.createAccessKeyFor) return;
